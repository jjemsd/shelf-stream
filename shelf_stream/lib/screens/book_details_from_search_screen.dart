...
class BookDetailsScreenFromSearch extends StatefulWidget {
  const BookDetailsScreenFromSearch({
    super.key,
  ...
  @override
  State<BookDetailsScreenFromSearch> createState() =>
      _BookDetailsScreenFromSearchState();
}

class _BookDetailsScreenFromSearchState
    extends State<BookDetailsScreenFromSearch> {
  @override
  Widget build(BuildContext context) {
    final bookDetails = widget.clickedSearchResult;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextButton(
                onPressed: () {
                  print('Owner: ${bookDetails['owner']}');
                },
                child: Text(
                  'Owner: ${bookDetails['owner'] ?? 'Unknown'}',
                  style: const TextStyle(
                    fontSize: 16,
              ...
              child: ElevatedButton(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "Request Borrow for ${bookDetails['title']}",
                      ),
                    ),
                  );
